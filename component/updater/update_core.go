...
var (
	...
	baseURL       string = "https://github.com/kitty314/1.18.9/releases/download/Prerelease-Alpha/clash"
	versionURL    string = "https://github.com/kitty314/1.18.9/releases/download/Prerelease-Alpha/version.txt"
	packageURL    string
...
func init() {
	...
	if !strings.HasPrefix(C.Version, "alpha") {
		baseURL = "https://github.com/kitty314/1.18.9/releases/latest/download/clash"
		versionURL = "https://github.com/kitty314/1.18.9/releases/latest/download/version.txt"
	}
}
